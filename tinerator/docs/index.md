# <small>Welcome to</small> TINerator

## Introduction

TINerator is a tool for the fast creation of extruded meshes from DEM and GIS data, developed at Los Alamos National Laboratory to aid in hydrogeological simulations.
...
This page is under active construction. Visit [Installation](install.md) and 
[Tutorials](tutorials/index.md) to get started.