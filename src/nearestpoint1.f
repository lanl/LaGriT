...
CCCCCCCCC CWG     pointer (ipdistpossleaf, distpossleaf)
 
      isubname='nearestpoint1'
      length=mtri
CCCCCCCCC CWG      call mmgetblk('distpossleaf',isubname,ipdistpossleaf,
CCCCCCCCC CWG     $     length,2,icscode)
...
CCCCCCCCC CWGc     Release memory block
CCCCCCCCC CWG      call mmrelblk('distpossleaf' ,isubname,ipdistpossleaf,icscode)
