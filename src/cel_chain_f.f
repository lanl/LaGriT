      subroutine cel_chain_f(cmo,field_name,toldamage,mpary_in,mpno_in,
...
c #####################################################################
     ...
     &   (ipinvmpary1,invmpary1), (iptollength,tollength)
...
c$$$      character*132 cbuf
     ...
     &   maxelt,maxedge,nelts,mpno1,previousmaxedge,nsd,nodeorig
       logical itsttp
      real*8 ascend,toldamage,distmax,
     &   dist,dist1
...
c.... contains the edge, but the edge's local position in that element.
     ...
     &      ,len_edges,1,icscode)
         ...
         call mmgetblk('tollength',isubname,iptollength,
     &       len_edges,2,icscode)
     ...
     &      ,icscode)
         ...
         call mmincblk('tollength',isubname,iptollength,inc,icscode)
