...
## LaGriT V1.0 Spring 1999

A summary of the major Changes found in this release are listed below.

**Note: This text is converted from old pdf files and translations may have mistakes.**
**For instance: l should be / (slash) and sometimes i should be _ (underscore).**
**See source pdf for clarification**
...
ungZavs/avs_file_out/ung_file_in/[z_va|ue]
